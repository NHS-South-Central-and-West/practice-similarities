...
Let us say that `practice-similarities/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a ReST file, and add the following line to reference the `practice-similarities` module:

```rest
.. currentmodule:: practice-similarities
```
...
Let us say that `practice-similarities/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a Markdown file, and add the following line to reference the `practice-similarities` module:
