# Code of conduct for `practice-similarities`

Contributors to this repository hosted by `NHS-South-Central-and-West` are expected to follow the
...
- "Project", we mean this `practice-similarities` GitHub repository;
- "Maintainer", we mean the `NHS-South-Central-and-West` organisation owners; and
- "Leadership", we mean both `NHS-South-Central-and-West` organisation owners, line managers, and other
  leadership within the NHS South Central and West[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[h,[C[D Central and West CSU.
...
[paul.johnson50@nhs.net][email-address]. All complaints will be
...
[email-address]: mailto:paul.johnson50@nhs.net
