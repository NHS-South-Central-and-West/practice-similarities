# practice-similarities documentation build configuration file
#
...
project = "practice-similarities"
author = "NHS-South-Central-and-West"
...
htmlhelp_basename = "practice-similaritiesdoc"
